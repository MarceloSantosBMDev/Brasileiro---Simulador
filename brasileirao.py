...
def tela_selecao_edicao():
    ...
    # Frame central para organizar os elementos
    ...
    # Botões com bordas arredondadas e sombra
    ...
    # Botão de modo aposta com estilo moderno
    ...
    # Adicionando um gradiente de fundo (opcional)
